...
| Step | 主题 | 核心概念 | 代码量 | 状态 |
|:---:|:---|:---|:---:|:---:|
| **17** | [旅行小管家](tutorials/step17/tutorial.md) | 单 Agent 应用，记忆与个性化 | ~1300行 | 📝 已规划 |
| **18** | [虚拟咖啡厅「星语轩」](tutorials/step18/tutorial.md) | 多 Agent 协作，虚拟世界 | ~1500行 | 📝 已规划 |
| **19** | [SaaS 化 AI 助手平台](tutorials/step19/tutorial.md) | 多租户、多用户、生产级架构 | ~1800行 | 📝 已规划 |

**学习重点：**
- **Step 17**: 单 Agent 实用应用（继承 Step 16 状态系统）
- **Step 18**: 多 Agent 虚拟世界（扩展为多角色互动）
- **Step 19**: SaaS 化平台（多租户、多用户、计费系统）
