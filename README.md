...
| Step | 主题 | 核心概念 | 代码量 | 状态 |
|:---:|:---|:---|:---:|:---:|
| **16** | [期中实战 — 智能客服机器人](tutorials/step16/tutorial.md) | RAG + 工具调用 + IM 接入 | ~1200行 | 📝 已规划 |
| **17** | [期末实战 — 企业级多 Agent 协作平台](tutorials/step17/tutorial.md) | 多角色 Agent、工作流引擎 | ~1500行 | 📝 已规划 |

**学习重点：**
- **Step 16**: 综合运用 Part 1-5 知识，构建完整客服系统
- **Step 17**: 企业级架构设计，多 Agent 协作、工作流编排
