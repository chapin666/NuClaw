...
| Step | 主题 | 核心概念 | 代码量 | 状态 |
|:---:|:---|:---|:---:|:---:|
| **17** | [期中实战 — 旅行小管家](tutorials/step17/tutorial.md) | 智能旅行规划助手 | ~1300行 | 📝 已规划 |

**学习重点：**
- 贴近生活的智能旅行助手
- 整合 RAG + 工具调用 + 用户画像 + 记忆系统
...
| Step | 主题 | 核心概念 | 代码量 | 状态 |
|:---:|:---|:---|:---:|:---:|
| **18** | [期末实战 — 虚拟咖啡厅「星语轩」](tutorials/step18/tutorial.md) | 多 NPC 情感社交模拟 | ~1500行 | 📝 已规划 |

**学习重点：**
- 有趣的虚拟社交空间
- 多 Agent 情感计算、关系网络、故事驱动
...
| Part 4: 高级 Agent | ✅ 部分完成 | 800-1000 |
| Part 5: 期中实战 | 📝 已规划 | ~1300 |
| Part 6: 期末实战 | 📝 已规划 | ~1500 |
